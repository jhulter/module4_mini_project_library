...
def borrow_book(library):
    ...
    if book_barrowed in library:
        library["Title"]({"Availability Status": "Unavailable"})
...
def search_books(library):
        search_book = input("What contact are you trying to find? ")
...
def add_book(library):
        ...
        book = Books(title, author, genre, isbn, publication_date, availability_status)
        library.update(book)
        print("Book Added!!!!")
